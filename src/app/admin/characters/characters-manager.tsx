    ...
    <>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">{characters.length} characters</p>
        </div>
        <button
          onClick={openCreate}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-3xl w-full max-w-lg shadow-2xl z-10 overflow-hidden max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
              <h3 className="font-bold text-gray-900 text-lg">{editChar ? "Edit Character" : "Add Character"}</h3>
            ...
            <div className="p-6 space-y-4">
              ...
              <button onClick={handleSave} disabled={loading}
                ...
                {loading ? <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : editChar ? "Save Changes" : "Create Character"}
              </button>
            </div>
          </div>
        </div>
      ...
      {deleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl p-6 max-w-sm w-full shadow-2xl z-10 text-center">
            ...
            <h3 className="font-bold text-gray-900 mb-2">Delete Character?</h3>
