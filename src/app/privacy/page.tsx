      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          {[
            ...
            { title: "5. Life Guiders", content: "The Life Guiders on our platform are powered by artificial intelligence. Conversations may be stored to improve the service. No conversation data is shared with third parties." },
