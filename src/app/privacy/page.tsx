      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          {[
            ...
            { title: "3. Data Storage", content: "Your data is stored securely using Supabase infrastructure with industry-standard encryption. Job applications are stored in our database and accessible only to administrators." },
            { title: "4. AI Characters", content: "The AI virtual characters on our platform are powered by artificial intelligence. Conversations may be stored to improve the service. No conversation data is shared with third parties." },
            { title: "5. Cookies", content: "We use essential cookies for authentication and session management. No tracking cookies are used without your consent." },
            { title: "6. Your Rights", content: "You have the right to access, correct, or delete your personal data. Contact us at privacy@workhub.com to exercise these rights." },
            { title: "7. Contact", content: "For privacy-related questions, please contact us at privacy@workhub.com." },
          ].map((section) => (
