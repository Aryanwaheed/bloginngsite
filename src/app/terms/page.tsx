      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="space-y-8">
          {[
            ...
            { title: "2. Use of Services", content: "WorkHub provides a job listing platform and Life Guider chat service. Job listings are for informational purposes. We do not guarantee employment. Users must be at least 18 years old." },
            ...
            { title: "4. Life Guiders", content: "Life Guiders are for entertainment and conversational purposes only. They are not real people. Do not share sensitive personal information in chat sessions. WorkHub is not liable for any decisions made based on AI conversations." },
            { title: "5. Prohibited Conduct", content: "Users may not use the platform for illegal purposes, post fraudulent job listings, harass other users, attempt to impersonate Life Guiders as real people, or attempt to reverse engineer the platform." },
